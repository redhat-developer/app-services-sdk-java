...
import com.openshift.cloud.api.kas.auth.models.ResetOffsetType;
...
public class ConsumerGroupResetOffsetParameters {
  ...
  private ResetOffsetType offset;
  ...
  public ConsumerGroupResetOffsetParameters offset(ResetOffsetType offset) {
  ...
  **/
  ...
  public ResetOffsetType getOffset() {
    return offset;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OFFSET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOffset(ResetOffsetType offset) {
    this.offset = offset;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(offset, topics, value);
  }
