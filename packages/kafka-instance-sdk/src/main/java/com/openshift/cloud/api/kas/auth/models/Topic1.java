...
@JsonPropertyOrder({
  Topic1.JSON_PROPERTY_NAME,
  Topic1.JSON_PROPERTY_IS_INTERNAL,
  Topic1.JSON_PROPERTY_PARTITIONS,
  Topic1.JSON_PROPERTY_CONFIG
})
@JsonTypeName("Topic_1")
...
public class Topic1 {
  ...
  public Topic1 name(String name) {
  ...
  **/
  ...
  public Topic1 isInternal(Boolean isInternal) {
  ...
  **/
  ...
  public Topic1 partitions(List<Partition> partitions) {
    
    this.partitions = partitions;
    return this;
  }

  public Topic1 addPartitionsItem(Partition partitionsItem) {
  ...
  **/
  ...
  public Topic1 config(List<ConfigEntry> config) {
    
    this.config = config;
    return this;
  }

  public Topic1 addConfigItem(ConfigEntry configItem) {
    if (this.config == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, topic1.name) &&
        Objects.equals(this.isInternal, topic1.isInternal) &&
        Objects.equals(this.partitions, topic1.partitions) &&
        Objects.equals(this.config, topic1.config);
  }
