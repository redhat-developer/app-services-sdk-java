...
public class KafkaRequestAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, cloudProvider, multiAz, region, owner, name, bootstrapServerHost, createdAt, updatedAt, failedReason, version, instanceType, instanceTypeName, reauthenticationEnabled, kafkaStorageSize, browserUrl, sizeId, ingressThroughputPerSec, egressThroughputPerSec, totalMaxConnections, maxPartitions, maxDataRetentionPeriod, maxConnectionAttemptsPerSec);
  }
