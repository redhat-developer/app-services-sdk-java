...
public class KafkaRequestPayload {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cloudProvider, name, region, hashCodeNullable(reauthenticationEnabled), plan, hashCodeNullable(billingCloudAccountId), hashCodeNullable(marketplace));
  }
